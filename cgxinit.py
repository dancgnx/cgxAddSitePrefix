...
def go():
    ...
    custom_group = parser.add_argument_group('custom_args', 'Add Site Prefixes')
    custom_group.add_argument("--prefixes", "-P",type=argparse.FileType('r'), help="text file with one prefix per line of prefixes to add",required=True,
                              default=None, action="store",dest="prefixes_file")
    custom_group.add_argument("--site","-S", help="Site name",
                              action="store",dest="site_name", required=True)
